                    ...
                    <div class="col-lg-6">
                        <div class="discover_item_inner">
                            <div class="discover_item">
                                ...
                                <p><?php echo $value['description']; ?><span><?php echo number_format($value['price']) ?> VND</span></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        ...
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/ph%C6%B0%C6%A1ng-nguy%E1%BB%85n-729641214/" target="_blank"><i class="fa fa-linkedin-square"></i></a></li>
                            <li><a href="https://www.facebook.com/profile.php?id=100014959182667" target="_blank"><i class="fa fa-facebook-square"></i></a></li>
                            <li><a href="#"><i class="fa fa-skype"></i></a></li>
                        </ul>
                    </div>
                    <a href="https://www.facebook.com/profile.php?id=100014959182667" target="_blank">
                        <h4>cẩm Nhi</h4>
                    </a>
                    <h5>Expert in Cake Making</h5>
                </div>
        ...
        <div class="row latest_news_inner">
            <div class="col-lg-4 col-md-6">
                <div class="l_news_image">
                    <div class="l_news_img">
                        <img class="img-fluid" src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[0]['product_id'])['pro_image'] ?>" alt="" style="height: 400px;">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid" src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[1]['product_id'])['pro_image'] ?>" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid" src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[2]['product_id'])['pro_image'] ?>" alt="">
                    </div>
                    <div class="l_news_text">
